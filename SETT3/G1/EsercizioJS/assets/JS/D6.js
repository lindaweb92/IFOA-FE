...
const slice1 = result.slice(0,2);
const slice2 = result.slice(9);
console.log(slice1,slice2);
const maiuscolo = result.toUpperCase();
...
*/
const numeri = [5,10,11,26];
const pari = numeri.filter(checkPari);
function checkPari (numeri) { return numeri <=10;
}
console.log(pari);
